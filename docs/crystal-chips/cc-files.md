...
| :------------------------ | :-----------------------------: | :-----------------------------: | :---------------------------------------------  |
| Crystal Chips BootManager | :material-close-circle-outline: | :material-check-circle:         | :material-check-circle:                         |
...
| Neutrino                  | :material-check-circle:         | :material-check-circle:         | :material-check-circle:                         |
