...
[![Tindie](assets/picfix/tindie-mediums.png){ width="100" align=left }](https://www.tindie.com/products/r3z3n/sony-ps2-matrix-picfix-flex-for-scph-700xx/) Tindie is a better choice for bulk purchases over 10 as it is 30% savings per unit. $10/per or $7/per 10 units and over. Shipping is $5 as it includes tracking. NOTE: product is waiting for Tindie approval
