...
SCPH-500XX GH-023, GH-026 and GH-029 motherboards
...
[![Tindie](assets/picfix/tindie-mediums.png){ width="100" align=left }](https://www.tindie.com/products/r3z3n/sony-ps2-matrix-picfix-flex-for-scph-700xx/) Tindie is a better choice for bulk purchases over 10 as it is 30% savings per unit. $10/per or $7/per 10 units and over. Shipping is $5 as it includes tracking.

[![Ko-Fi](assets/picfix/support_me_on_kofi_badge_red.png){ width="100" align=left}](https://ko-fi.com/r3z3n/shop) $10/per and shipping is $5 as it includes tracking. Gerbers, BOM and Placement file here as well!

[![Ebay](assets/picfix/ebay_logo.png){ width="100" align=left}](https://www.ebay.com/itm/116567931846) Ebay is the only choice for worldwide shipping from me, $11 due to ebay fees and shipping is calculated by them.
